...
DEVICE_OBJECT* _pktmon_ebpf_ext_driver_device_object;

_pktmonebpf_ext_helper::_pktmonebpf_ext_helper() : _pktmonebpf_ext_helper(nullptr, nullptr, nullptr) {}

_pktmonebpf_ext_helper::_pktmonebpf_ext_helper(
    _In_opt_ const void* npi_specific_characteristics,
    _In_opt_ _ebpf_extension_dispatch_function dispatch_function,
    _In_opt_ pktmonebpfext_helper_base_client_context_t* client_context)
{
...
std::vector<GUID>
_pktmonebpf_ext_helper::program_info_provider_guids()
{
...
_pktmonebpf_ext_helper::get_program_info_provider_data(_In_ const GUID& program_info_provider)
{
...
NTSTATUS
_pktmonebpf_ext_helper::_program_info_client_attach_provider(
    _In_ HANDLE nmr_binding_handle,
    _Inout_ void* client_context,
    _In_ const NPI_REGISTRATION_INSTANCE* provider_registration_instance)
{
    auto& helper = *reinterpret_cast<_pktmonebpf_ext_helper*>(client_context);
...
NTSTATUS
_pktmonebpf_ext_helper::_program_info_client_detach_provider(_Inout_ void* client_binding_context)
{
...
void
_pktmonebpf_ext_helper::_program_info_client_cleanup_binding_context(_In_ _Post_invalid_ void* client_binding_context)
{
    UNREFERENCED_PARAMETER(client_binding_context);
}

NTSTATUS
_pktmonebpf_ext_helper::_hook_client_attach_provider(
    _In_ HANDLE nmr_binding_handle,
    _Inout_ void* client_context,
    _In_ const NPI_REGISTRATION_INSTANCE* provider_registration_instance)
{
    ...
    auto base_client_context = reinterpret_cast<pktmonebpfext_helper_base_client_context_t*>(client_context);
...
NTSTATUS
_pktmonebpf_ext_helper::_hook_client_detach_provider(_Inout_ void* client_binding_context)
{
    UNREFERENCED_PARAMETER(client_binding_context);
...
void
_pktmonebpf_ext_helper::_hook_client_cleanup_binding_context(_In_ void* client_binding_context)
{
    UNREFERENCED_PARAMETER(client_binding_context);
}
