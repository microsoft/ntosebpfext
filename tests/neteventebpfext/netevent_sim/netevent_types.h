...
#define NETEVENT_TEST_SOURCE_IP_OCTET_1 192
#define NETEVENT_TEST_SOURCE_IP_OCTET_2 168
#define NETEVENT_TEST_SOURCE_IP_OCTET_3 1
#define NETEVENT_TEST_SOURCE_IP_OCTET_4 1
#define NETEVENT_TEST_DESTINATION_IP_OCTET_1 10
#define NETEVENT_TEST_DESTINATION_IP_OCTET_2 11
#define NETEVENT_TEST_DESTINATION_IP_OCTET_3 12
#define NETEVENT_TEST_DESTINATION_IP_OCTET_4 1
#define NETEVENT_TEST_SOURCE_PORT 12345
#define NETEVENT_TEST_DESTINATION_PORT 80
