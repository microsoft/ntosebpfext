...
typedef struct _neteventebpfext_helper_base_client_context
{
    class _neteventebpf_ext_helper* helper;
    void* provider_binding_context;
    bpf_attach_type_t desired_attach_type; // BPF_ATTACH_TYPE_UNSPEC for any allowed.
} neteventebpfext_helper_base_client_context_t;

typedef class _neteventebpf_ext_helper
{
  public:
  ...
  private:
    ...
    {
        _neteventebpf_ext_helper* parent;
