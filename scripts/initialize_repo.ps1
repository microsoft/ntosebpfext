...
$commands = @(
    ...
    { & cmake -G $cmakeGenerator -S external\catch2 -B external\catch2\build -DBUILD_TESTING=OFF '-DCMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded$<$<CONFIG:Debug>:Debug>$<$<CONFIG:FuzzerDebug>:Debug>' },
