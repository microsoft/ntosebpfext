...
#define EBPF_EXT_DEVICE_NAME_TEMPLATE_(EBPF_EXT_DEVICE_NAME_PREFIX, _PROVIDER_NAME) \
    EBPF_EXT_DEVICE_NAME_PREFIX L#_PROVIDER_NAME

#define EBPF_EXT_DEVICE_NAME_TEMPLATE(_PROVIDER_NAME) \
    EBPF_EXT_DEVICE_NAME_TEMPLATE_(L"\\device\\ebpf_ext_", _PROVIDER_NAME)
