...
#include "pktmon_export_program_info.h"
...
static const ebpf_program_info_t* _program_information_array[] = {&_ebpf_pktmon_event_program_info};

// ebpf_program_section_info_t _mock_pktmon_event_section_info[] = {
//    {.header =
...
// static const ebpf_program_info_t* _program_information_array[] = {&_mock_pktmon_event_section_info};

static std::vector<ebpf_program_section_info_with_count_t> _section_information = {
    {&_ebpf_pktmon_event_section_info[0], 1},
};
